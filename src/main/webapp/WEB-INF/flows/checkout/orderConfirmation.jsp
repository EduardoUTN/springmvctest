  ...
  <body>
    <section>
      <div class="jumbotron">
        <div class="container">
          <div class="row">
            <form:form modelAttributte="order" class="form-horizontal">
                    ...
                    <tbody>
                      <c:forEach var="cartItem" items="${order.cart.cartItems}">
                        <tr>
                          ...
                          <td class="col-md-1" style="text-align: center"><em>${cartItem.value.quantity}</em></td>
                          <td class="col-md-1 text-center"><em>$${cartItem.value.product.unitPrice}</em></td>
                          <td class="col-md-1 text-center"><em>$${cartItem.value.totalPrice}</em></td>
                        </tr>
                      </c:forEach>
                      <tr>
                        <td> </td>
